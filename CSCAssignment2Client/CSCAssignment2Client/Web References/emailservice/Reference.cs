...
namespace CSCAssignment2Client.emailservice {
    ...
    public partial class EmailWebService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public void SendEmailAsync(string msgFrom, string pass, string msgTo, string msgSubject, string msgBody) {
            this.SendEmailAsync(msgFrom, pass, msgTo, msgSubject, msgBody, null);
        }
        
        /// <remarks/>
        public void SendEmailAsync(string msgFrom, string pass, string msgTo, string msgSubject, string msgBody, object userState) {
            ...
            this.InvokeAsync("SendEmail", new object[] {
                        ...
                        msgTo,
                        msgSubject,
                        msgBody}, this.SendEmailOperationCompleted, userState);
        }
